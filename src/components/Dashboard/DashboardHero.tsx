      ...
      >
        ...
        {challengeOfTheDay && (
          <Carousel.Slide>
            <HeroSlide
              ...
              type={t('dashboard.dailyChallenge')}
              link={`/challenges/${challengeOfTheDay.id}`}
              actionLabel={t('dashboard.acceptChallenge')}
              color="orange"
              icon={IconTarget}
            />
          </Carousel.Slide>
        ...
        {featuredBuild && (
          <Carousel.Slide>
            <HeroSlide
              ...
              subtitle={t('dashboard.featuredBuildDesc', { defaultValue: `A powerful build for ${featuredBuild.game_name} by ${featuredBuild.username || t('common.unknown')}` })}
              type={t('dashboard.featuredBuild')}
              link={`/builds/${featuredBuild.id}`}
              actionLabel={t('dashboard.viewBuild')}
              color="blue"
              icon={IconSword}
            />
          </Carousel.Slide>
        ...
        <Carousel.Slide>
          <HeroSlide
            ...
            title={t('dashboard.liveBingoEvents')}
            subtitle={t('dashboard.activeRoomsDesc', { count: activeRoomCount })}
            type={t('dashboard.multiplayer')}
            link="/bingo-challenges"
            actionLabel={t('dashboard.playBingo')}
            color="green"
            icon={IconTrophy}
          />
        </Carousel.Slide>
